...
import { findEmissions, findLinearAntinodes, findUniqueAntinodes } from "./utils";

const PartTwo = ({ city }: InputData) => {
  ...
  const recordUniqueAntinodes = () => {
    ...
    const antinodes = findLinearAntinodes(emissions, city[0].length, city.length);
